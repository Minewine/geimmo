...
async def run():
    ...
    async with async_playwright() as p:
        ...
        await page.goto(
            "https://www.immobilier.ch/fr/carte/louer/appartement-maison/geneve/page-1?t=rent&c=1;2&p=s40&nb=false&gr=1",
            timeout=60000
        )
        ...
        await page.locator("input#min-price-range").fill("800")
        await page.locator("input#max-price-range").fill("1400")

        await page.get_by_role("button", name=re.compile(r"Pièces")).click()
        await page.locator("input#min-room-range").fill("1.5")
        await page.locator("input#max-room-range").fill("4")
